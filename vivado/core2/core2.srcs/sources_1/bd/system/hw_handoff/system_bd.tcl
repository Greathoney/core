...
proc create_root_design { parentCell } {
  ...
  # Create instance: textlcd_2_0, and set properties
  set textlcd_2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:textlcd_2:1.0 textlcd_2_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins textlcd_2_0/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins pushbutton_0/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins tftlcd_0/S00_AXI]

  # Create port connections
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins textlcd_2_0/clk] [get_bd_pins tftlcd_0/clk]
  connect_bd_net -net pb_0_1 [get_bd_ports pb_0] [get_bd_pins pushbutton_0/pb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pushbutton_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins textlcd_2_0/s00_axi_aclk] [get_bd_pins tftlcd_0/s00_axi_aclk]
  ...
  connect_bd_net -net resetn_0_1 [get_bd_ports resetn_0] [get_bd_pins textlcd_2_0/resetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pushbutton_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins textlcd_2_0/s00_axi_aresetn] [get_bd_pins tftlcd_0/s00_axi_aresetn]
  connect_bd_net -net textlcd_2_0_lcd_data [get_bd_ports lcd_data_0] [get_bd_pins textlcd_2_0/lcd_data]
  connect_bd_net -net textlcd_2_0_lcd_en [get_bd_ports lcd_en_0] [get_bd_pins textlcd_2_0/lcd_en]
  connect_bd_net -net textlcd_2_0_lcd_rs [get_bd_ports lcd_rs_0] [get_bd_pins textlcd_2_0/lcd_rs]
  connect_bd_net -net textlcd_2_0_lcd_rw [get_bd_ports lcd_rw_0] [get_bd_pins textlcd_2_0/lcd_rw]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C90000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pushbutton_0/S00_AXI/S00_AXI_reg] SEG_pushbutton_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs textlcd_2_0/S00_AXI/S00_AXI_reg] SEG_textlcd_2_0_S00_AXI_reg
